		...
		extend: {
			colors: {
				...
				vault: {
					...
					'primary-foreground': 'hsl(var(--vault-primary-foreground))',
					secondary: 'hsl(var(--vault-secondary))',
					'secondary-foreground': 'hsl(var(--vault-secondary-foreground))',
					accent: 'hsl(var(--vault-accent))',
					'accent-foreground': 'hsl(var(--vault-accent-foreground))',
